...
export default function GalleryCard({project, onOpen, index}) {
    ...
    return (
        ...
        >
            {project.image.endsWith('.mp4') ? <video src={project.image} className="w-full h-80 object-cover" autoPlay muted loop playsInline loading="lazy"/> : <img src={project.image} className="w-full h-80 object-cover" loading="lazy"/>}
