        ...
        <section className="bg-[#080808] px-6 md:px-12 lg:px-20 py-24">
            ...
            <div className="grid grid-cols-3 gap-4">
                {projects.map((project, index) => (
                    ...
                    >
                        {project.image.endsWith('.mp4') ? <video src={project.image} className="w-full h-80 object-cover" autoPlay muted loop playsInline /> : <img src={project.image} className="w-full h-80 object-cover" />}
